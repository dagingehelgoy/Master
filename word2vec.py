...
words = read_data('data/datasets/Flickr30k.txt')
...
def save_model(labels, embeddings):
	...
	for word_text, word_vector in zip(labels, embeddings):
		count += 1
		word_embeddings_dict[labels[word_text]] = word_vector
	print(count)
	save_pickle_file(word_embeddings_dict, "word2vec_embedding_dict.pkl")
